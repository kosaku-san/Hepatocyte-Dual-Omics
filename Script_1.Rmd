...
```{r}
#protein intensities
protein_intensities <- read.delim("required_files/report.tsv.protein_intensities.tsv", row.names = 1)
...
#ion intensities
ion_intensities <- read.delim("required_files/report.tsv.ion_intensities.tsv")
...
```{r}
sample_table <- read.csv("required_files/sample_table.csv")
...
```{r}
#load data
RNA_pca_data <- read.csv(file = "required_files/RNAseq_pca3Ddata.csv", row.names = 1)
